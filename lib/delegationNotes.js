...
// separate surfaces render these messages: the interactive open-tier table
// (app/bids/YourBidsPanel.js, a client component) and the read-only
// closed-tier recap (app/bids/page.js, server-rendered). A copy of the
// sentinel string in each would be two things to drift out of step with
// the database -- the same argument that keeps the message text itself out
// of JavaScript.
//
