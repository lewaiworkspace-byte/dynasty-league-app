...
//   /admin/calendar -- the Calendar Loader; every calendar_* function calls
//                      require_commissioner() as well
//   appointing a co-commissioner -- loadOwnerRoles() and setCoCommissioner()
//                                   in app/admin/owner-activity/actions.js.
//                                   NARROWER THAN THE PAGE THEY SIT ON: that
//                                   page is widened, this control is not.
...
//   /admin/sync-players  /admin/import-stats -- widened September 16, 2026,
//                        implementing the September 8 ruling that struck
//                        Technical Manual Appendix A.2(c). Both write through
//                        adminClient(), so their action checks are the whole gate.
//   /admin/sleeper-sync  /admin/injury-sync  /admin/trades  /admin/restructure
//   /admin/fifth-year-option
//   /admin/owner-activity -- the page and its activity report only
//   plus canCut on /team/[teamId], which is how a cut from another team's
//   roster is actually reached
//
// A page's gate does not automatically cover everything rendered on it.
// /admin/owner-activity is the standing example: widened page, strict control.
//
